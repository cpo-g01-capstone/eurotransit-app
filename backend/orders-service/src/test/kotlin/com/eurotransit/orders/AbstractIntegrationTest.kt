package com.eurotransit.orders
...
@EmbeddedKafka(
    partitions = 1,
    topics = ["order-placed", "inventory-reserved", "payment-authorized", "order-confirmed", "order-failed"],
)
abstract class AbstractIntegrationTest {
    companion object {
        ...
        // dead database. Stopped on JVM shutdown. (Same pattern as notifications-service.)
        @JvmStatic
